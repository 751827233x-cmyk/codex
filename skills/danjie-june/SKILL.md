...
2. If producing a full storyboard execution draft, load `references/full-guidelines.md`, `references/axis-continuity.md`, `references/high-density-storyboard.md`, `references/industrial-control-system.md`, `references/staging-entrance-system.md`, `references/cinematic-shot-language.md`, `references/camera-cutting-spatial-methodology.md`, and `references/action-function-causality.md`; follow all eight as the authoritative specification.
3. Before splitting, perform a compact control pass: identify source mode, name mode, core conflict, true plot boundaries, active character count, load level, dominant timing driver, opening/entrance/exit staging needs, action-function and cause-effect chain, spatial state, master spatial relationship, shot-language strategy, shot-capacity risks, sound plan, and opening/escalation/aftermath visual anchors.
